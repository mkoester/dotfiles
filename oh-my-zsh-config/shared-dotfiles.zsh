...
create_new_user_with_shared_config () {
    ...
    sudo su -c "ln -s $SHARED_DIR/oh-my-zsh-config/zsh-disable-compfix.zsh ~/.oh-my-zsh-config/" $NEW_USER_NAME && \
    sudo su -c "ln -s $SHARED_DIR/oh-my-zsh-config/omz-no_automatic_updates.zsh ~/.oh-my-zsh-config/" $NEW_USER_NAME && \
